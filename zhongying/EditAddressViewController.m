...
@synthesize textProvince, textCity, textDistrict, textName, textPhone, textAddress, textZipCode, currentAddress;
...
{
    self.textZipCode.text = self.currentAddress.zipCode;
    self.textProvince.text = self.currentAddress.provinceName;
    self.textPhone.text = self.currentAddress.phone;
    self.textName.text = self.currentAddress.name;
    self.textDistrict.text = self.currentAddress.districtName;
    self.textCity.text = self.currentAddress.cityName;
    self.textAddress.text = self.currentAddress.address;
    
    currentProvince = [[RegionInformation alloc] init];
    currentProvince.regionId = self.currentAddress.provinceId;
    currentProvince.regionName = self.currentAddress.provinceName;
    
    currentCity = [[RegionInformation alloc] init];
    currentCity.regionId = self.currentAddress.cityId;
    currentCity.regionName = self.currentAddress.cityName;
    
    currentDistrict = [[RegionInformation alloc] init];
    currentDistrict.regionId = self.currentAddress.districtId;
    currentDistrict.regionName = self.currentAddress.districtName;
}
...
- (void)sendEditAddressRequest
{
    ...
    if([self.textName.text length] == 0){
        ...
        EditAddressRequestParameter *request = [[EditAddressRequestParameter alloc] init];
        ...
        request.addressId = self.currentAddress.addressId;
        
        [[CommunicationManager instance] editAddress:request withDelegate:self];
