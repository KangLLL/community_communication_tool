...
@synthesize labelTime, labelTitle, scrollContent, notification;
...
{
    [super viewDidLoad];
    self.labelTime.text = [NSString stringWithFormat:NOTIFICATION_TIME_TEXT_FORMAT,notification.time];
    self.labelTitle.text = notification.title;
    ...
    CGSize contentSize = [notification.content sizeWithFont:font constrainedToSize:CGSizeMake(CONTENT_WIDTH, 10000) lineBreakMode:NSLineBreakByWordWrapping];
...
- (void)sendReadNotification
{
    ...
    request.messageId = notification.messageId;
